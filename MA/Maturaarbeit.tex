...
The act of defecting appearing alluring since there is a chance of avoiding a long sentence.
...
In order to retrieve the most important scientific findings on this topic, a literature search was conducted on scholar.google.com with the search terms 'Prisoner's Dilemma' and 'random strategy' (for details see Appendix xxx).
...
\subsection{Appendix A. Literature Search}
In order to retrieve the most important scientific findings on the topic of PD and erratic behavior, a literature search was conducted on scholar.google.com with the search terms Prisoner's Dilemma and random strategy. To narrow down the search to scientific findings, first of all books (54), mere citations (20) and papers not written in English language (6) were excluded from the 650 hits as well as items with no more than 10 citations (362). On the basis of the titles of the remaining 208 articles, papers were eliminated that delt with the evolutionary (55) or other (14) PD variants (e.g., with more players), the role of noise or information use (12), implementational or analytical aspects (42) or special applications (34; e.g., in human-robot interaction). For the remaining 51 items, 50 could be retrieved from the University of Bern library (access via the University’s talent promotion program). 
The screening of the abstracts led to a further exclusion of items due to their actual focus on the evolutionary PD variant (10; e.g., Van Segbroeck et al., 2009), the introduction of more than two players (5; e.g., Izquierdo et al., 2004), other PD variants (8; e.g., Hayashi & Yamagishi, 1998), strategy learning (10; e.g., Han et al., 2022), or specific aspects like philosophical considerations (7; e.g., McLean, 1981). For the remaining ten articles, pdf files were downloaded from the University of Bern Library and studied in more detail. After deleting two more items, in which either a different game was researched (Back & Flache, 2006: exchange dilemma) or “random strategy” was used as randomly choosing a certain strategy from a set of strategies (Chen & Fu, 2023), eight publications finally remained, which were considered as being most relevant for the present topic. These publications are briefly summarized in subsection 2.5.

...
Excellent overviews are available in standard encyclopedia, from which the information reported in 2.1–2.4 was compiled, in particular the \textit{International Encyclopedia of the Social and Behavioral Sciences} (Rios and Cresto, 2015) and the \textit{Stanford Encyclopedia of Philosophy} (Kuhn, 2025).

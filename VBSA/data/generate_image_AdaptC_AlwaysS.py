...
fig.update_layout(
    ...
    yaxis=dict(range=[0, 1], title="Invesment", dtick=0.1
    )
)

fig.write_image(f"plots/Discussion/Adapt-Continuous/Approx_{parameter_B}_line_chart_{parameter_start}-{parameter_end}.png")
